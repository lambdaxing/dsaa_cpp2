...
#ifndef arrayQueue_9_8_
#define arrayQueue_9_8_
...
public:
	...
	bool empty() const { return theFront == theBack && lastOp != 1; }
	int size() const { return (theBack - theFront + arrayLength) % arrayLength; }
	T& front()
	{// return front element
		if (theFront == theBack && lastOp != 1)
			throw queueEmpty();
...
private:
	...
	int lastOp;			// 0: nothing , 1: push , 2: pop 
};
