...
#ifndef COMPLETE_WINNER_TREE_
#define COMPLETE_WINNER_TREE_
...
void completeWinnerTree<T>::initialize(T* thePlayer, int theNumberofPlayers)
{
	...
	if (n < 2)
		throw illegalParameterValue("must hava at least 2 players");
	...
	// handle remainning external nodes
	if (n % 2 == 1)
...
{// play matches beginning at tree[p]
 ...
 // rightChild if right child of p
