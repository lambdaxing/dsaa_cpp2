...
int numberOfCars;
int numberOfTracks;
int smallestCar;			// smallest car in holding track
int itsTrack;				// holding track with car smallestCar

void outputFrontHoldingTrack()
...
{// Put car c into a holding track. Return false iff there is no feasible holding track for this car.
	...
	// find best hoding track for car c
	// initialize
	...
	// update smallestCar and itsTrack iff need
	if (c < smallestCar)
	{
		smallestCar = c;
		itsTrack = bestTrack;
