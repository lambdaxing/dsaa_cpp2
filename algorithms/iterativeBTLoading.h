...
{// weight[1:numberOfContainers] are container weights
 ...
 // bestLoading[1:numberOfContainers] is solution arrray
 // Return weight of max loading.
	...
	{// move down and left as far as possible
		while (currentLevel <= numberOfContainers && weightOfCurrentLoading + weight[currentLevel] <= capacity)
		{// move to left child
